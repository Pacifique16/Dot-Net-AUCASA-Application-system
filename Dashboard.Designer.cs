namespace AUCASAPRO_26937
{
	partial class Dashboard
	{
		...
		private void InitializeComponent()
		{
			...
			this.label9.Text = "Total Positions:";
			// 
			// label10
			// 
			...
			this.label11.Text = "Applications by Department";
			// 
			// label12
			// 
			...
			this.label12.Text = "Applications by Position";
			// 
			// dataGridView1
			// 
			...
			this.panel2.Location = new System.Drawing.Point(200, 20);
			...
			this.panel4.Location = new System.Drawing.Point(560, 20);
			...
			this.panel5.Size = new System.Drawing.Size(160, 80);
			...
			this.Text = "Statistics Dashboard - AUCASAPRO";
